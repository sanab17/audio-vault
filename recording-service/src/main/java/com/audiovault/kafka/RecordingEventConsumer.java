...
public class RecordingEventConsumer {
    ...
    public void onRecordingCreated(RecordingEvent event) {
        log.info("Consumed recording.created event: id={}, file={}, duration={}s", event.getId(), event.getFileName(), event.getDuration());
    }
    ...
    public void onRecordingDeleted(RecordingEvent event) {
        log.info("Consumed recording.deleted event: id={}, file={}", event.getId(), event.getFileName());
    }
}
